...
// Epics
function getFilmsEpic(action$) {
  return action$.ofType(GET_FILMS_AJAX).switchMap(function(action) {
    const limit = action.payload;

    return Observable.ajax({
      url: `https://www.snagfilms.com/apis/films.json?limit=${limit}`,
      method: "GET",
      crossDomain: true
    })
...
export const filmsLibraryEpic = combineEpics(getFilmsEpic);
